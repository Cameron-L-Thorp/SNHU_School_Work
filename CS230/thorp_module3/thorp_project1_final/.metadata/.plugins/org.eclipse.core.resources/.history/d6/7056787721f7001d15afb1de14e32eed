...
public class GameService {
	...
	public Game addGame(String name) {
		...
		//This iterator use used to go through all games within the games list and return one(if any) with the same name
	...
	public Game getGame(long id) {
		...
		//This iterator use used to go through all games within the games list and assigns to game one(if any) with the same id
		for (int i = 0; i  < instance.getGameCount(); i++)
		{
	...
	public Game getGame(String name) {
		...
		//This iterator use used to go through all games within the games list and assigns to game one(if any) with the same name
		for (int i = 0; i  < instance.getGameCount(); i++)
		{
			if (games.get(i).name == name)
			{
